...
router.get('/my', authenticate, authorize('CUSTOMER'), ReturnController.getMyReturnRequests);

// VENDOR
router.get('/vendor', authenticate, authorize('VENDOR'), ReturnController.getVendorReturnRequests);
router.patch(
  '/:returnId/resolve',
  authenticate,
  authorize('VENDOR'),
